  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <style jsx global>{`
          /* Responsive sidebar width variables */
          [data-slot="sidebar-wrapper"] { --sidebar-width: 14rem; }
          /*
...
function Sidebar({
  ...
  return (
    <motion.div
      initial={{ width: collapsible === 'offcanvas' && state === 'collapsed' ? 0 : 'fit-content' }}
      animate={{ width: collapsible === 'offcanvas' && state === 'collapsed' ? 0 : 'fit-content' }}
      transition={{ duration: 0.3, ease: 'easeInOut' }}
      className={cn(
        "group peer text-sidebar-foreground hidden md:block bg-transparent",
      )}
      data-state={state}
...
const sidebarMenuButtonVariants = cva(
  ...
  group-data-[collapsible=icon]:p-2! group-data-[collapsible=icon]:h-10! 

...
const sheetVariants = cva('fixed z-50 gap-4 bg-background py-4 px-0 shadow-lg', {
    variants: {
        side: {
        ...
        <AnimatePresence>
            {isOpen && (
                <SheetPortal forceMount data-slot="sheet-portal">
                    {overlay && (
                        <SheetOverlay asChild forceMount className={sheetOverlayClassName}>
                            <motion.div
                                key="sheet-overlay"
                                data-slot="sheet-overlay"
                    ...
                    <SheetPrimitive.Content asChild forceMount {...props}>
                        ...
                        >
                            ...
                            <SheetPrimitive.Close
                                ...
                                className="close-button absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary"
                            >
                                <X className="h-4 w-4" />
